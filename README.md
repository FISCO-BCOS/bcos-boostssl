...
bcos-boostssl is a generic network library based on the 'WebSocket' protocol, which can be used as both a server and a client. The underlying implementation is based on 'Boost' and 'TASSL' and supports both SSL and SM SSL connections.
